...
Obesity is defined as the accumulation of excess adipose tissue in the body that is sufficient enough to impair body health or function. Those categorized as obese are generally considered to be 25-27% above the ideal body weight (Linder and Mueller, 2014). Obesity is a disorder that humans and domesticated animals, like cats, commonly suffer from. Both humans and domesticated animals are experiencing a steady increase in the number of affected individuals (Scarlett *et al.*, 1994). Obesity is usually the result of an imbalance in dietary intake, energy utilization, or genetics. The factors that may lead to these imbalances range from a variety of internal and causes like activity level, environmental lifestyle, hormonal levels, and genetics. Some of the effects that obesity can have on domesticated animals can be detrimental. It can lead to problems such as orthopedic disease, diabetes, cardiorespiratory disease, urinary disorders, dermatological diseases, and neoplasia (German, 2006). The culmination of these problems leads an overall poor health and an inevitable increase in mortality.
...
**Figure 3**: This is an inferred phylogenetic tree of sequences present within the three sample types.
    ...
    ## Run 0 stress 0 
    ## Run 1 stress 0 
    ## ... Procrustes: rmse 0.1931525  max resid 0.4688567 
    ## Run 2 stress 0 
    ## ... Procrustes: rmse 0.1877121  max resid 0.4303533 
    ## Run 3 stress 0 
    ## ... Procrustes: rmse 0.199522  max resid 0.4727435 
    ## Run 4 stress 0 
    ## ... Procrustes: rmse 0.2004511  max resid 0.4760638 
    ## Run 5 stress 0 
    ## ... Procrustes: rmse 0.2031792  max resid 0.5023087 
    ## Run 6 stress 0 
    ## ... Procrustes: rmse 0.2013436  max resid 0.4812223 
    ## Run 7 stress 0 
    ## ... Procrustes: rmse 0.2017525  max resid 0.5166726 
    ## Run 8 stress 0 
    ## ... Procrustes: rmse 0.1975172  max resid 0.5156016 
    ## Run 9 stress 0 
    ## ... Procrustes: rmse 0.1988278  max resid 0.4708025 
    ## Run 10 stress 0 
    ## ... Procrustes: rmse 0.192898  max resid 0.4392739 
    ## Run 11 stress 0 
    ## ... Procrustes: rmse 0.198875  max resid 0.4549397 
    ## Run 12 stress 0 
    ## ... Procrustes: rmse 0.2002763  max resid 0.4933356 
    ## Run 13 stress 0 
    ## ... Procrustes: rmse 0.1963499  max resid 0.5376888 
    ## Run 14 stress 0 
    ## ... Procrustes: rmse 0.1988404  max resid 0.4689182 
    ## Run 15 stress 0 
    ## ... Procrustes: rmse 0.2015091  max resid 0.4696315 
    ## Run 16 stress 0 
    ## ... Procrustes: rmse 0.1980174  max resid 0.4774963 
    ## Run 17 stress 0 
    ## ... Procrustes: rmse 0.2014874  max resid 0.4878824 
    ## Run 18 stress 0 
    ## ... Procrustes: rmse 0.1974398  max resid 0.4765929 
    ## Run 19 stress 0 
    ## ... Procrustes: rmse 0.1853751  max resid 0.4646488 
    ## Run 20 stress 0 
    ## ... Procrustes: rmse 0.1962262  max resid 0.506089 
